...
public abstract class LocalSessionFactory implements BeanReplacer, HasAfterInject, DataSourceInt {
  private final TransactionManager transactionManager = new GreetgoTransactionManager();
  private final TransactionFactory transactionFactory = new kz.greetgo.home.register.util.LocalTransactionFactory(transactionManager);
